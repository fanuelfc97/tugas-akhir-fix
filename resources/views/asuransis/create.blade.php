...
@section('title', 'Input Polis Asuransi')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Input Polis Asuransi</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Input Polis Asuransi</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row my-5">
    <div class="card card-primary card-outline mb-4">
        <form method="POST" action="{{ route('asuransis.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">

                <div class="mb-3">
                    <label for="no_polis" class="form-label">No Polis Asuransi</label>
                    <input type="text" name="no_polis" class="form-control" id="no_polis" placeholder="Masukkan No Polis">
                </div>
                ...
                <div class="mb-3">
                    <label for="dokumen_polis" class="form-label">Dokumen Polis Asuransi</label>
                    <div class="input-group mb-3">
                        <input type="file" name="dokumen_polis" class="form-control" id="dokumen_polis" required>
                        <label class="input-group-text" for="dokumen_polis">Upload</label>
                    </div>
                </div>
