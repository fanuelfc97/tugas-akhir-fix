...
@section('title', 'Input Sewa Lahan')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Input Sewa Lahan</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Input Sewa Lahan</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row my-5">
    <div class="card card-primary card-outline mb-4">
        <form method="POST" action="{{ route('sewalahans.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">

                <div class="mb-3">
                    <label for="no_kontrak" class="form-label">No Kontrak</label>
                    <input type="text" name="no_kontrak" class="form-control" id="no_kontrak" placeholder="Masukkan No Kontrak">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input type="file" name="dokumen_sl" class="form-control" id="dokumen_sl" required>
                        <label class="input-group-text" for="dokumen_sl">Upload</label>
                    </div>
                </div>
