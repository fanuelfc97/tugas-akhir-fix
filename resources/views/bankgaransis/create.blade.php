...
@section('title', 'Input Bank Garansi')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Input Bank Garansi</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Input Bank Garansi</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row my-5">
    <div class="card card-primary card-outline mb-4">
        <form method="POST" action="{{ route('bankgaransis.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">

                <div class="mb-3">
                    <label for="no_jaminan" class="form-label">No Jaminan Bank Garansi</label>
                    <input type="text" name="no_jaminan" class="form-control" id="no_jaminan" placeholder="Masukkan No Jaminan">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input type="file" name="dokumen_bg" class="form-control" id="dokumen_bg" required>
                        <label class="input-group-text" for="dokumen_bg">Upload</label>
                    </div>
                </div>
