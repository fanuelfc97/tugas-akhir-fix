...
@section('title', 'Detail Bank Garansi')
...
<div class="app-content-header"> <!--begin::Header-->
    <div class="container-fluid"> <!--begin::Container-->
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Detail Bank Garansi</h3>
            </div>
            <div class="col-sm-6">
...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <!-- No Bank Garansi -->
            <div class="mb-3">
                <label for="no_jaminan" class="form-label">No Bank Garansi</label>
                <input type="text" id="no_jaminan" class="form-control" value="{{ $bankgaransi->no_jaminan }}" readonly>
            </div>

            <!-- Periode Awal -->
            <div class="mb-3">
                <label for="periode_awal" class="form-label">Periode Awal</label>
                <input type="text" id="periode_awal" class="form-control" value="{{ $bankgaransi->periode_awalbg }}" readonly>
            </div>

            <!-- Periode Akhir -->
            <div class="mb-3">
                <label for="periode_akhir" class="form-label">Periode Akhir</label>
                <input type="text" id="periode_akhir" class="form-control" value="{{ $bankgaransi->periode_akhirbg }}" readonly>
            </div>
            ...
            <!-- Dokumen Bank Garansi -->
            <div class="mb-3">
                <label for="dokumen_bg" class="form-label">Dokumen Bank Garansi</label>
        ...
        <div class="card-footer">
            <a href="{{ route('bankgaransis.index') }}" class="btn btn-danger">Kembali</a>
        </div>
        <!--end::Footer-->
    </div> <!--end::Card-->
</div> <!--end::Row-->
