...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Input Skpd</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Input Skpd</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row my-5">
    <div class="card card-primary card-outline mb-4">
        <form method="POST" action="{{ route('skpds.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">

                <div class="mb-3">
                    <label for="no_skpd" class="form-label">No SKPD</label>
                    <input type="text" name="no_skpd" class="form-control" id="no_skpd" placeholder="Masukkan No SKPD">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input type="file" name="dokumen_skpd" class="form-control" id="dokumen_skpd" required>
                        <label class="input-group-text" for="dokumen_skpd">Upload</label>
                    </div>
                </div>
